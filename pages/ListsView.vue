      ...
      return {
        doc: {
          ...
          examples: [
            ...
            { header: 'Dense Lists', file: 'lists/11', desc: `A list can be <code>dense</code> which lowers the line height and font size per material.io specs. Shows an example of what is theoretically possible with everything lining up properly` }
          ],
          props: {
            'v-list': {
              params: [
